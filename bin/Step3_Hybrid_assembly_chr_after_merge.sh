...
#SBATCH --output=Step3_Hybrid_assembly_chr_after_merge.sh.stdout
#SBATCH -p intel
#SBATCH --workdir=./
...
#fasta=/rhome/cjinfeng/BigData/00.RD/Assembly/bionano/input/Pacbio_assembly/chromosome/Fairchild_chr$N\.fasta_contig.fasta
fasta=/rhome/cjinfeng/BigData/00.RD/Assembly/10xgenomics/bin/contig_gragh/fairchild_graph_57G_chr$N\_bwa_merge/Final_Ref.fasta
...
output=/rhome/cjinfeng/BigData/00.RD/Assembly/bionano/bin/Fairchild_hybridscaffold_chr$N\_aggressive_after_merge
...
denovo_dir=/rhome/cjinfeng/BigData/00.RD/Assembly/bionano/install/Solve_03062017Rel/PIPELINE/Pipeline
